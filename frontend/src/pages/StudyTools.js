...
const StudyTools = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Study Tools</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Enhance your learning with powerful tools</p>
      </div>
