...
const Library = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">eBook Library</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Explore and read your collection</p>
      </div>
